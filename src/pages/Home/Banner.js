...
const Banner = ({ banner, widb, getData }) => {
 ...
 const uploadImg = (e) => {
  ...
  const updateForm = (profilePath) => {
    console.log(profilePath,"updateprofile...")
    let data1 = {
      heading: heading,
  ...
  const submitForm = profilePath => {
    ...
    let data = {
      ...
      name_staticPages: 'New-Banner2',
      data_staticPages: JSON.stringify(data1),
      isActive_staticPages: "",
      createdTime_staticPages: ' ', 
      updatedTime_staticPages: ' '
    }
      ...
      <Paper elevation={16}>
        <ContentStyle>
          ...
          {formstatus ? (
              ...
              <Stack spacing={3}>
                ...
                <Grid container spacing={3} style={{ margin: '7px -24px' }}>
                  <Grid item xs={12} sm={6} md={6}>
                    ...
                    <div className=''>
                      {/* <img src={files ? files.source : img} className='h-img' alt='preview' /> */}
            ...
            <>
              <h5 className='w-h5' style={{textAlign:'center'}}>{banner.heading}</h5>
              <img src={img} className='h-img' alt='icons' />
