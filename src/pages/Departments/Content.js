...
const Content = ({ onSubmit, tid, getData, content }) => {
  ...
  const [parap4, setParap4] = useState('')
  const [parap5, setParap5] = useState('')
  const [parap6, setParap6] = useState('')
  const [parap7, setParap7] = useState('')
  ...
  useEffect(() => {
    if (rowdata) {
      ...
      setParap4(rowdata.parap4);
      setParap5(rowdata.parap5);
      setParap6(rowdata.parap6);
      setParap7(rowdata.parap7);
              ...
              <MBForm onSubmit={formSubmit}>
                <Stack spacing={3}>
                  ...
                  />
                   <MBTextField
                    fullWidth
                    name={parap4} value={parap4} id={parap4} key={'parap4'} validate={valid}
                    onChange={e => {
                      setParap4(e.target.value)
                    }}
                    label={'Paragraph4'}
                  />
                   <MBTextField
                    fullWidth
                    name={parap5} value={parap5} id={parap5} key={'parap5'} validate={valid}
                    onChange={e => {
                      setParap5(e.target.value)
                    }}
                    label={'Paragraph5'}
                  />
                   <MBTextField
                    fullWidth
                    name={parap6} value={parap6} id={parap6} key={'parap6'} validate={valid}
                    onChange={e => {
                      setParap6(e.target.value)
                    }}
                    label={'Paragraph6'}
                  />
                   <MBTextField
                    fullWidth
                    name={parap7} value={parap7} id={parap7} key={'parap7'} validate={valid}
                    onChange={e => {
                      setParap7(e.target.value)
                    }}
                    label={'Paragraph7'}
                  />
                  <MBTextArea
                ...
                <>
                  ...
                  <p className="w-p-cont">{content.parap4}</p>
                  <p className="w-p-cont">{content.parap5}</p>
                  <p className="w-p-cont">{content.parap6}</p>
                  <p className="w-p-cont">{content.parap7}</p>
